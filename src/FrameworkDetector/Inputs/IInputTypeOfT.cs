...
public interface IInputType<T> : IInputType
{
    ...
    public virtual static Task<IInputType> CreateAndInitializeDataSourcesAsync(T input, CancellationToken cancellationToken) => throw new NotImplementedException("Input Type did not implement CreateAsync method.");
}
